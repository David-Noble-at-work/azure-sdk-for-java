...
enum BloomFilterStrategies implements BloomFilter.Strategy {
    /**
     * See "Less Hashing, Same Performance: Building a Better Bloom Filter" by Adam Kirsch and Michael Mitzenmacher. The
     * paper argues that this trick doesn't significantly deteriorate the performance of a Bloom filter (yet only needs
    ...
    /**
     * This strategy uses all 128 bits of {@link Hashing#murmur3_128} when hashing. It looks different than the
     * implementation in MURMUR128_MITZ_32 because we're avoiding the multiplication in the loop and doing a (much
     * simpler) += hash2. We're also changing the index to a positive number by AND'ing with Long.MAX_VALUE instead of
     * flipping the bits.
     */
    MURMUR128_MITZ_64() {
        @Override
    ...
    static final class LockFreeBitArray {
        ...
        /**
         * Instantiates a new Lock free bit array.
         *
         * @param bits the bits
         */
        ...
        /**
         * Returns true if the bit changed value.  @param bitIndex the bit index
         *
         * @return the boolean
         */
         ...
         * in mind.
         *
         * @param atomicLongArray the atomic long array
         *
         * @return the long [ ]
         */
        ...
        /**
         * Number of bits  @return the long
         */
        long bitSize() {
         ...
         * close *estimate* of the actual number of bits set. It's not possible to do better than an estimate without
         * locking. Note that the number, if not exactly accurate, is *always* underestimating, never overestimating.
         *
         * @return the long
         */
        long bitCount() {
        ...
        /**
         * Copy lock free bit array.
         *
         * @return the lock free bit array
         */
         ...
         * this operation is executing, not all of those new 1's may be set in the final state of this LockFreeBitArray.
         * The ONLY guarantee provided is that all the bits that were set in the other LockFreeBitArray at the start of
