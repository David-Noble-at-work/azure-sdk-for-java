...
/**
 * An abstract composition of multiple hash functions. {@linkplain #newHasher()} delegates to the {@code Hasher} objects
 * of the delegate hash functions, and in the end, they are used by {@linkplain #makeHash(Hasher[])} that constructs the
 * final {@code HashCode}.
 *
...
abstract class AbstractCompositeHashFunction extends AbstractHashFunction {
    ...
    /**
     * Constructs a {@code HashCode} from the {@code Hasher} objects of the functions. Each of them has consumed the
     * entire input and they are ready to output a {@code HashCode}. The order of the hashers are the same order as the
    ...
    @SuppressWarnings("deprecation")  // Suppresses warning that Hasher.hashCode has been deprecated
