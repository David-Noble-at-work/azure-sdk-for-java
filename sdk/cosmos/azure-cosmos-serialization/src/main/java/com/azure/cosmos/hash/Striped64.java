...
abstract class Striped64 extends Number {
    ...
    /**
     * ThreadLocal holding a single-slot int array holding hash code. Unlike the JDK8 version of this class, we use a
     * suboptimal int[] representation to avoid introducing a new type that can impede class-unloading when ThreadLocals
     * are not removed.
     */
    ...
    /**
     * CASes the base field.  @param cmp the cmp
     *
     * @param val the val
     *
     * @return the boolean
    ...
    /**
     * Handles cases of updates involving initialization, resizing, creating new Cells, and/or contention. See above for
     * explanation. This method suffers the usual non-modularity problems of optimistic retry code, relying on rechecked
     * sets of reads.
     *
     * @param x the value
