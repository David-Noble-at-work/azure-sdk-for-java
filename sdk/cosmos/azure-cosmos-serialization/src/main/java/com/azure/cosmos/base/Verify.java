 ...
 * <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/language/assert.html">assertions</a>,
 * except that they are always enabled. These methods should be used instead of Java assertions whenever there is a
 * chance the check may fail "in real life". Example:
 *
 * <pre>{@code
 ...
 * which approach to use, <b>don't worry</b> too much about it; just pick something that seems reasonable and it will be
 * fine.
 *
 * <ul>
...
public final class Verify {
    ...
    /**
     * Ensures that {@code expression} is {@code true}, throwing a {@code VerifyException} with a custom message
     * otherwise.
     *
