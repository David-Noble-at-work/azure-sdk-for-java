...
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutListReadable;
...
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypePrimitive;
...
public final class RowReader {
     ...
     */
    public RowReader(@NotNull RowBuffer buffer) {
     ...
     */
    public RowReader(@NotNull final RowBuffer buffer, @NotNull final Checkpoint checkpoint) {
     ...
     * <p>
     * A {@link RowReader} instance traverses all of the top-level fields of a given scope. If the root scope is
     * provided then all top-level fields in the buffer are enumerated. Nested child {@link RowReader} instances can be
     * access through the {@link RowReader#readScope} method to process nested content.
     */
    private RowReader(@NotNull final RowBuffer buffer, @NotNull final RowCursor scope) {
     ...
     * is a nullable Null primitive value, this method return true if the value is set (even though its values is set to
     * null).
     *
     ...
     */
    @NotNull
    public Result readUInt8(@NotNull Out<Short> value) {
     ...
     * @return {@link Result#SUCCESS} if the read is successful, an error {@link Result} otherwise.
     */
    public Result skipScope(@NotNull final RowReader nestedReader) {
    ...
    /**
     * Returns a string representation of this {@link RowReader}.
     * <p>
     * The {@link RowReader} is represented as a string of the form <b>{@linkplain RowReader}(</b><i>&lt;
     * json-string&gt;</i><b>)</b>.
     *
     * @return string representation of the this {@link RowReader}.
     */
    @Override
     ...
     */
    @NotNull
    private <TValue> Result readPrimitiveValue(@NotNull Out<TValue> value) {
    ...
    static final class JsonSerializer extends StdSerializer<RowReader> {
        ...
        public void serialize(
            final RowReader value,
            final JsonGenerator generator, final
