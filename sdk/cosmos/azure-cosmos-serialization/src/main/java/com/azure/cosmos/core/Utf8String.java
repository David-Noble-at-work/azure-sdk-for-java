...
public final class Utf8String implements ByteBufHolder, CharSequence, Comparable<Utf8String> {
    ...
    private Utf8String(@NotNull final ByteBuf buffer) {
    ...
    private Utf8String(@NotNull String value) {
     ...
     * <p>
     * Use this method judiciously as indexing a {@link Utf8String} in UTF-16 code units incurs an O(n) time cost. Use
     * {@link #chars} for sequential access to UTF-16 code units. Consider converting this {@link Utf8String} to a
     * {@link String}, if random access to {@code char} values is required. The time cost incurred by {@link
     ...
     * this {@link Utf8String} is lexicographically less than the {@code string} argument; and a value greater than 0 if
     * this {@link Utf8String} is lexicographically greater than the {@code string}  argument.
     */
     ...
     * numeric value of each 8-bit encoded byte, you will get the same result as if you first decoded the string into
     * Unicode and compared the numeric values of each code point.
     *
     ...
     *
     * @return a deep copy of this {@link Utf8String}, or a value of {@link #NULL} or {@link #EMPTY}, if this {@link
     * Utf8String} is null or empty.
     */
    @Override
     ...
     *
     * @return a duplicate of this {@link Utf8String}, or a value of {@link #NULL} or {@link #EMPTY}, if this {@link
     * Utf8String} is null or empty.
     */
    @Override
     ...
     *
     * @return {@code true} if the given {@link String} represents the same sequence of characters as this {@link
     ...
     *
     * @return {@code true} if the given {@link Utf8String} represents the same sequence of characters as this {@link
     * Utf8String}, {@code false} otherwise.
     */
     ...
     */
    @NotNull
    public static Optional<Utf8String> from(@NotNull final ByteBuf buffer) {
     ...
     */
    @NotNull
    public static Utf8String fromUnsafe(@NotNull ByteBuf buffer) {
        checkNotNull(buffer, "expected non-null buffer");
     ...
     * split into a surrogate pair. This exception will only be thrown on sequences containing 4-byte UTF-8 encodings.
     ...
     * construction of an instance of this class must be a leading byte. This is used to determine the number of UTF-8
     * code units (i.e., bytes) in the code point.
     * <p>
     ...
     * single-byte UTF-8 code units in the code point. The {@link #process(byte)} method returns {@code false} when an
     * undefined code point is encountered as determined by {@link Character#isDefined(int)}}.
     *
     * @see <a href="https://tools.ietf.org/html/rfc3629">RFC 3629: UTF-8, a transformation format of ISO 10646</a>
     */
     ...
     * with 4 8-bit code units, and vice versa. Lead bytes are identified and counted. All other bytes are skipped. Code
     ...
     * <a href="https://en.wikipedia.org/wiki/Specials_(Unicode_block)#Replacement_character">Replacement
     * Characters</a>
     */
