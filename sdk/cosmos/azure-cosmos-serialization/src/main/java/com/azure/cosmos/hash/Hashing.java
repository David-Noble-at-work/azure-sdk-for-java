...
public final class Hashing {
  ...
  static final int GOOD_FAST_HASH_SEED = (int) System.currentTimeMillis();
     ...
     * <a href="https://github.com/aappleby/smhasher/blob/master/src/MurmurHash3.cpp">32-bit murmur3 algorithm, x86
   ...
   *
   * @return a hash function implementing the
   * <a href="https://github.com/aappleby/smhasher/blob/master/src/MurmurHash3.cpp">128-bit murmur3 algorithm, x64
   * variant</a> (little-endian variant), using the given seed value.
   */
   ...
   * Returns a hash function implementing the Message Authentication Code (MAC) algorithm.
   * <p>
   * The function uses the SHA-256 (256 hash bits) hash function and a {@link SecretKeySpec} created from the given byte
   ...
   * Returns a hash function implementing the Message Authentication Code (MAC) algorithm.
   * <p>
   * The function uses the SHA-512 (512 hash bits) hash function and a {@link SecretKeySpec} created from the given byte
   ...
   * Section 12.1.
   *
   * <p>This function is best understood as a <a href="https://en.wikipedia.org/wiki/Checksum">checksum</a> rather than
   * a true <a href="https://en.wikipedia.org/wiki/Hash_function">hash function</a>.
   *
   ...
   * <p>
   * FarmHash fingerprints are encoded by {@link HashCode#asBytes} in little-endian order. This means
   * {@link HashCode#asLong} is guaranteed to return the same value that farmhash::Fingerprint64() would for the same
   * input (when compared using {@link com.google.common.primitives.UnsignedLongs}'s encoding of 64-bit unsigned
   * numbers).
   * <p>
   ...
   * minimizes the need for remapping as {@code buckets} grows.
   * <p>
   * That is, {@code consistentHash(h, n)} equals:
   * <ul>
   *   <li>{@code n - 1}, with approximate probability {@code 1/n}
   ...
   * <p>
   * That is, whenever two equal hash codes are produced by two calls to this method, it is <i>as likely as possible</i>
