...
public final class LayoutColumn {
    ...
    public LayoutColumn(
        ...
        @NotNull final StorageKind storage, final LayoutColumn parent, int index, int offset,
        @NotNull final LayoutBit nullBit, @NotNull final LayoutBit booleanBit, int length) {
     ...
     */
    @NotNull
    private static String fullPath(final LayoutColumn parent, @NotNull final String path) {
