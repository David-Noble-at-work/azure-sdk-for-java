...
public final class RowScanner implements AutoCloseable, Iterable<DataItem> {
     ...
     */
    public static RowScanner open(@NotNull Namespace namespace, @NotNull File file) throws IOException {
        ...
        checkArgument(length <= Integer.MAX_VALUE, "expected file length <= %s, not %s",
            Integer.MAX_VALUE,
            length);
     ...
     * @throws IOException if an I/O error occurs opening the {@code file}.
     */
    public static RowScanner open(@NotNull Namespace namespace, @NotNull Path path) throws IOException {
     ...
     * @throws IOException if an I/O error occurs opening the {@code file}.
     */
    public static RowScanner open(@NotNull Namespace namespace, @NotNull String path) throws IOException {
