...
public final class SchemaValidator {
    ...
    private static void visit(
        ...
        if (p instanceof UdtPropertyType) {
            ...
            if (up.schemaId() != SchemaId.INVALID) {
                ...
                Assert.areEqual(up.name(), s.name(),
                    lenientFormat("Schema name '%s' does not match the name of schema with id '%s': %s",
                        up.name(),
                        up.schemaId(),
                        s.name()));
            }
    ...
    private static final class SchemaIdentification implements Comparable<SchemaIdentification> {
        ...
        private SchemaIdentification(@NotNull final String name, @NotNull final SchemaId id) {
        ...
        @Override
        public int compareTo(@NotNull SchemaIdentification other) {
