...
public final class LayoutMongoDbObjectId extends LayoutType/*<MongoDbObjectId>*/ {
    ...
    //    }
    //
    //    //C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created
    //    above:
    //    //ORIGINAL LINE: public override Result WriteSparse(ref RowBuffer b, ref RowCursor edit, MongoDbObjectId
    //    value,
