...
import com.azure.cosmos.serialization.hybridrow.schemas.ObjectPropertyType;
import com.azure.cosmos.serialization.hybridrow.schemas.PrimitivePropertyType;
import com.azure.cosmos.serialization.hybridrow.schemas.Property;
import com.azure.cosmos.serialization.hybridrow.schemas.PropertyType;
import com.azure.cosmos.serialization.hybridrow.schemas.Schema;
import com.azure.cosmos.serialization.hybridrow.schemas.ScopePropertyType;
import com.azure.cosmos.serialization.hybridrow.schemas.SetPropertyType;
import com.azure.cosmos.serialization.hybridrow.schemas.TaggedPropertyType;
...
public final class LayoutCompiler {
     ...
     */
    @NotNull
    public static Layout compile(@NotNull final Namespace namespace, @NotNull final Schema schema) {
    ...
    private static void addProperties(
        @NotNull final LayoutBuilder builder,
        @NotNull final Namespace namespace,
        @NotNull LayoutCode layoutCode,
    ...
    private static LayoutType logicalToPhysicalType(
        ...
        switch (logicalType.type()) {
            ...
            case MAP:
                ...
                if (mp.keys() != null && (mp.keys().type() != TypeKind.ANY) && (mp.values() != null)
                    && (mp.values().type() != TypeKind.ANY)) {
            ...
            case TAGGED: {
                ...
                if (tg.items().size() < TaggedPropertyType.MIN_TAGGED_ARGUMENTS
                    || (tg.items().size() > TaggedPropertyType.MAX_TAGGED_ARGUMENTS)) {
                    throw new LayoutCompilationException(lenientFormat(
