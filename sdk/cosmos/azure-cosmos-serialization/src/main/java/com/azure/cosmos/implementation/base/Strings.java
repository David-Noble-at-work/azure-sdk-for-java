...
public final class Strings {
     ...
     * use {@link String#isEmpty()} instead of this method, and you won't need special null-safe forms of methods like
     ...
     * {@link java.io.PrintWriter#format PrintWriter.format}, and related methods. These support the full range of <a
     * href="https://docs.oracle.com/javase/9/docs/api/java/util/Formatter.html#syntax">format specifiers</a>, and alert
     * you to usage errors by throwing {@link java.util.IllegalFormatException}.
     *
     * <p>In certain cases, such as outputting debugging information or constructing a message to be
     * used for another unchecked exception, an exception during string formatting would serve little purpose except to
     * supplant the real information you were trying to provide. These are the cases this method is made for; it instead
     * generates a best-effort string with all supplied argument values present. This method is also useful in
     * environments such as GWT where {@code String.format} is not available. As an example, method implementations of
     * the {@link Preconditions} class use this formatter, for both of the reasons just discussed.
     *
    ...
    /**
     * Returns a string, of length at least {@code minLength}, consisting of {@code string} appended with as many copies
     * of {@code padChar} as are necessary to reach that length. For example,
     *
     * <ul>
     ...
     * input string is always returned.
    ...
    /**
     * Returns a string, of length at least {@code minLength}, consisting of {@code string} prepended with as many
    ...
    private static String lenientToString(@Nullable Object o) {
        try {
            ...
            Logger.getLogger("com.azure.cosmos.implementation.base.Strings")
