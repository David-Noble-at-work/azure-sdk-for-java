...
import com.azure.cosmos.serialization.hybridrow.codecs.Float128Codec;
...
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutBit;
...
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutDateTime;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutDecimal;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutEndScope;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutFloat128;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutFloat32;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutFloat64;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutGuid;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutInt16;
...
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTagged;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTagged2;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTuple;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutType;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypeScope;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypedArray;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypedMap;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypedSet;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypedTuple;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutTypes;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUDT;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUInt16;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUInt32;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUInt64;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUInt8;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUnixDateTime;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutUtf8;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutVarInt;
import com.azure.cosmos.serialization.hybridrow.layouts.LayoutVarUInt;
import com.azure.cosmos.serialization.hybridrow.layouts.StringToken;
import com.azure.cosmos.serialization.hybridrow.layouts.StringTokenizer;
...
public final class RowBuffer {
     ...
     */
    public RowBuffer(final int capacity, @NotNull final ByteBufAllocator allocator) {
     ...
     * Hence, the caller should not maintain a reference to the buffer or mutate the buffer after this call returns.
    ...
    public RowBuffer(
        ...
        @NotNull final HybridRowVersion version,
        @NotNull final LayoutResolver resolver) {
     ...
     */
    public void deleteSparse(@NotNull final RowCursor edit) {
    ...
    /**
     * Compute the byte offsets from the beginning of the row for a given sparse field insertion. into a set/map.
     *
     ...
     */
    @NotNull
    public RowCursor prepareSparseMove(@NotNull final RowCursor scope, @NotNull final RowCursor srcEdit) {
     ...
     */
    public boolean readBit(final int offset, @NotNull final LayoutBit bit) {
    ...
    public boolean readFrom(
        @NotNull final InputStream inputStream, final int byteCount, @NotNull final HybridRowVersion version,
        @NotNull final LayoutResolver resolver) {
        ...
        checkState(byteCount >= HybridRowHeader.BYTES, "expected byteCount >= %s, not %s",
            HybridRowHeader.BYTES,
            byteCount);
     ...
     */
    public boolean readFrom(
        @NotNull final ByteBuf input, @NotNull final HybridRowVersion version, @NotNull final LayoutResolver resolver) {
     ...
     */
    public NullValue readSparseNull(@NotNull RowCursor edit) {
     ...
     */
    public Utf8String readSparsePath(@NotNull final RowCursor edit) {
    ...
    public int readSparsePathLen(
        ...
        final int offset,
        @NotNull final Out<Integer> pathOffset,
        @NotNull final Out<Integer> pathLengthInBytes) {
     ...
     * @return the {@code VariableUInt} value read.
     */
    public long readVariableUInt(final int offset, @NotNull final Out<Integer> length) {
        Item<Long> item = this.read(this::read7BitEncodedUInt, offset);
     ...
     */
    public RowCursor sparseIteratorReadScope(@NotNull final RowCursor edit, boolean immutable) {

        LayoutTypeScope scopeType = edit.cellType() instanceof LayoutTypeScope
            ? (LayoutTypeScope) edit.cellType()
            : null;
        ...
        if (scopeType instanceof LayoutTypedArray || scopeType instanceof LayoutTypedSet
            || scopeType instanceof LayoutTypedMap) {
        ...
        if (scopeType instanceof LayoutTypedTuple || scopeType instanceof LayoutTuple
            || scopeType instanceof LayoutTagged || scopeType instanceof LayoutTagged2) {
    ...
    public void typedCollectionMoveField(
        ...
        @NotNull final RowOptions options) {
     ...
     * range of an unsigned 32-bit integer, [0, 0x00000000FFFFFFFFL].
     *
     ...
     */
    public void writeTo(@NotNull final OutputStream stream) throws IOException {
    ...
    private int compareFieldValue(
        @NotNull final RowCursor left, final int leftLength, @NotNull final RowCursor right, final int rightLength) {
    ...
    /**
     * Compares the values of two encoded key-value pair fields using the hybrid row binary. collation.
     *
     * @param left An edit describing the left field.
     * @param right An edit describing the right field.
     *
     ...
     *
     * @param code the type of the default sparse value.
     * @param typeArgs the type args of the default sparse value.
     */
    ...
    private static int countSparsePath(@NotNull final RowCursor edit) {
    ...
    private void ensureSparse(
        final int length,
        @NotNull final RowCursor edit,
        @NotNull final LayoutType type,
        @NotNull final TypeArgumentList typeArgs,
        @NotNull final RowOptions options,
        @NotNull final Out<Integer> metaBytes,
        @NotNull final Out<Integer> spaceNeeded,
        @NotNull final Out<Integer> shift
    ) {
        ...
        if (edit.scopeType().isSizedScope() && !edit.scopeType().isFixedArity()) {
            ...
            if ((options == RowOptions.INSERT) || (options == RowOptions.INSERT_AT)
     ...
     * @param uniqueIndex A unique index array structure that identifies the row offsets of each element in the scope.
     *
     ...
     * Insertion Sort is used for this purpose as it guarantees that each value is eventually compared against its
     * previous item in sorted order.  If any two successive items are the same they must be duplicates.
     * <p>
     * Other search algorithms, such as Quick Sort or Merge Sort, may offer fewer comparisons in the limit but don't
     * necessarily guarantee that duplicates will be discovered.  If an alternative algorithm is used, then an
     * independent duplicate pass MUST be employed.
     * </p>
     * <p>
     * Under the current operational assumptions, the expected cardinality of sets and maps is expected to be relatively
     * small.  If this assumption changes, Insertion Sort may no longer be the best choice.
     * </p>
     */
    private boolean insertionSort(
        @NotNull final RowCursor scope,
        @NotNull final RowCursor edit,
        @NotNull final List<UniqueIndexItem> uniqueIndex) {
    ...
    private <T> Item<T> read(@NotNull final Supplier<T> reader, @NotNull final RowCursor cursor) {
    ...
    private <T> Item<T> read(@NotNull final Supplier<T> reader, final int offset) {
    ...
    private <T> Item<T> read(@NotNull final Function<Integer, T> reader, final int offset, final int length) {
     ...
     * <p>
     * {@code edit.MetaOffset} On success, the offset to the metadata of the field, otherwise a location to insert the
     * field.
     * <p>
     * {@code edit.cellType} On success, the layout code of the existing field, otherwise undefined.
     * <p>
     * {@code edit.TypeArgs} On success, the type args of the existing field, otherwise undefined.
     * <p>
     * {@code edit.ValueOffset} On success, the offset to the value of the field, otherwise undefined. .
     */
    private void readSparseMetadata(@NotNull final RowCursor edit) {
    ...
    private void readSparsePrimitiveTypeCode(@NotNull final RowCursor edit, @NotNull final LayoutType code) {
    ...
    private int skipScope(RowCursor edit) {
        for (;;) {
            if (this.sparseIteratorMoveNext(edit)) {
                continue;
            }
     ...
     */
    private boolean validateHeader(@NotNull final HybridRowVersion version) {
    ...
    private <T> Item<T> write(@NotNull final Consumer<T> consumer, final int offset, @NotNull final T value) {
    ...
    private void writeSparseMetadata(
        @NotNull final RowCursor edit, @NotNull final LayoutType cellType, @NotNull final TypeArgumentList typeArgs,
        final int metaBytes) {
    ...
    private void writeSparsePath(@NotNull final RowCursor edit, final int offset) {
