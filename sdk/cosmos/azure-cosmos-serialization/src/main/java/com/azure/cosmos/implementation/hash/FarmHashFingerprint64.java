...
import static com.azure.cosmos.implementation.hash.LittleEndianByteArray.load32;
import static com.azure.cosmos.implementation.hash.LittleEndianByteArray.load64;
...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    /**
     * Computes intermediate hash of 32 bytes of byte array from the given offset. Results are returned in the output
     * array because when we last measured, this was 12% faster than allocating new arrays every time.
     */
